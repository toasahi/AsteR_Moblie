...
val eccart =
    TestData("", "20m先", "ECCアーティスト専門学校", Geometry(GeometryLocation(lat = 34.70728890078992, lng = 135.50340175953764)))
val con = TestData(
    "",
    "30m先",
    "デイリーヤマザキ+ＭＢＳ茶屋町店",
    Geometry(GeometryLocation(lat = 34.70864569605197, lng = 135.50030746718386))
)
...
val sakuranbo =
    TestData("", "", "さくらんぼ", Geometry((GeometryLocation(lat = 34.703148349016196, lng = 135.50279249377016))))
val byoin = TestData("", "", "日本生命病院", Geometry((GeometryLocation(lat = 34.6904902, lng = 135.4919676))))
val con2 =
    TestData("", "", "ローソン北区万歳町店", Geometry((GeometryLocation(lat = 34.705697314917415, lng = 135.50431596239108))))
